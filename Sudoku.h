...
private:
  ...
  int assign_value( bool mutiple, Backtrack *Stack, int posX, int posY, int current_state );
  ...
  bool solve_sub( bool multiple, Backtrack* Stack, int posX, int posY, int current_state, int counter );
